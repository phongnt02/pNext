...
@section('content')
    <div class="sm:flex m-4">
        <div class="hidden sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
            <form class="lg:pr-3" action="" method="GET">
                ...
                <div class="mt-1 relative lg:w-64 xl:w-[30rem] flex justify-around">
                    <input type="text" name="name_chapters" id="users-search"
                        value="{{ isset($listBag->SearchTransform['name_chapters']) ?  $listBag->SearchTransform['name_chapters'] : old('name_chapters')}}"
        ...
        <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
            <a type="button"
                href="{{ route('chapters.add', ['courses_id' => $courses_id ]) }}"
    ...
    <x-ResultSearch :listBag="$listBag" :routeNext="'lessons'"/>
@endsection
