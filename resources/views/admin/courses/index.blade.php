...
@section('content')
    <div class="sm:flex m-4">
        <div class="hidden sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
            <form class="lg:pr-3" action="{{ route('courses.index') }}" method="GET">
                ...
                <div class="mt-1 relative lg:w-64 xl:w-96 flex justify-around">
                    <input type="text" name="SearchTransform" id="users-search"
                        value="{{ $listBag->SearchTransform ?  $listBag->SearchTransform : old('SearchTransform')}}"
        ...
        <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
            <a type="button" data-modal-toggle="add-user-modal"
