...
function Home() {
    ...
    return (
        <div className="w-full h-auto bg-primary px-32">
            <div className="flex h-auto py-8">
                <div className="h-full w-full">
                    <h3 className="text-white text-6xl ont-mono py-4 w-full">{data.introduce?.title}</h3>
            ...
            <div className="w-full h-auto py-24 flex justify-between">
                ...
                <div className="h-full w-1/2">
                    <h3 className="text-white text-4xl ont-mono py-12 w-full">{data.difference?.title}</h3>
            ...
            <div className="w-full h-auto py-16 flex justify-center flex-col items-center">
                <h3 className="text-white text-4xl ont-mono py-24 w-full text-center">Feedback</h3>
